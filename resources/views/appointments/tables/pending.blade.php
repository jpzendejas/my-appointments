    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <form class="d-inline-block" action="{{url('/appointments/'.$appointment->id.'/confirm')}}" method="post">
            @csrf
          ...
          <a class="btn btn-sm btn-danger" href="{{url('/appointments/'.$appointment->id.'/cancel')}}"><i class="ni ni-fat-delete"></i></a>
          @else
          <form class="d-inline-block" action="{{url('/appointments/'.$appointment->id.'/cancel')}}" method="post">
            @csrf
